 ...
 *                            [[DisableUnnecessaryBucketedScan]] for details.
 * @param charVarcharScanMode CHAR/VARCHAR scan mode bound during analysis. It participates in
 *                            plan identity so legacy, preserve-native, and standard scans are not
 *                            reused across modes. None means the scan is unbound.
 */
